    ...
    <div>
        <div className="booking-main-box booking-viewlogin-CachDeu4Canh">
          <div>
            ...
            <div className="booking-viewlogin-link" onClick={showModal}>Log In or Register</div>
            <Modal width={400} title="Log in to your account" visible={isModalVisible} footer={null} onCancel={handleCancel}>
              <Login/>
            </Modal>
          </div>
        </div>
